...
CANONICAL_POLICY_CODE_ALIASES: dict[str, str] = {
    ...
    "ZIKA": "ZIKA",
    "1D48": "ZIKA",
    "SALMONELLA_ENTERITIS": "SALMONELLA_ENTERITIS",
    "1A09.0": "SALMONELLA_ENTERITIS",
    "SHIGELLA": "SHIGELLA",
    "1A02": "SHIGELLA",
